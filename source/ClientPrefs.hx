...
class ClientPrefs {
	...
	public static var keyBinds:Array<Dynamic> = [
		...
		[Control.LEFT, 'Left '],		//Added a space for not conflicting on ControlsSubState
		[Control.DOWN, 'Down '],		//Added a space for not conflicting on ControlsSubState
		[Control.UP, 'Up '],			//Added a space for not conflicting on ControlsSubState
		[Control.RIGHT, 'Right '],	//Added a space for not conflicting on ControlsSubState
